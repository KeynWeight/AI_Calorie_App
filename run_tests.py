...
def main():
    ...
    parser.add_argument("--ci", action="store_true", help="Run CI/CD tests (fast unit tests only)")
    ...
    parser.add_argument("--category", help="Run tests for specific category (unit, nutrition, vision, etc.)")
    parser.add_argument("--full-pipeline", action="store_true", help="Run complete CI/CD pipeline")
