...
from calorie_app.models.nutrition import (
    Ingredient, DishNutrition, UserModification, 
    NutrientInfo, DynamicNutritionData
)
...
class TestIngredient:
    ...
    def test_ingredient_from_dynamic_nutrition(self):
        ...
        nutrients = {
            "1008": NutrientInfo(name="Energy", amount=248, unit="kcal", nutrient_id="1008"),
            "1003": NutrientInfo(name="Protein", amount=46.2, unit="g", nutrient_id="1003"),
            "1004": NutrientInfo(name="Total lipid (fat)", amount=5.4, unit="g", nutrient_id="1004"),
            "1005": NutrientInfo(name="Carbohydrate", amount=0.0, unit="g", nutrient_id="1005"),
        }
...
class TestDynamicNutritionData:
    ...
    def test_to_json_export(self):
        ...
        assert json_export["usda_info"]["description"] == "Chicken, broiler or fryers, breast, meat only, cooked"
