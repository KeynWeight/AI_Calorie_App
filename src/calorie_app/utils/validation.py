...
class NutritionValidator:
    ...
    def validate_structure(data: Dict) -> Dict[str, bool]:
        ...
        validation = {"has_required_fields": True, "field_details": {}}
    ...
    def validate_numeric_ranges(data: Dict) -> Dict[str, bool]:
        ...
        validation = {"values_in_range": True, "range_details": {}}
    ...
    def validate_calorie_consistency(data: Dict) -> Dict[str, bool]:
        ...
        validation = {"calories_consistent": True, "consistency_details": {}}
        ...
        try:
            ...
            tolerance = (
                calories * SystemLimits.CALORIE_VARIANCE_TOLERANCE
                if calories > 0
                else 50
            )
    ...
    def validate_nutrition_response(cls, data: Dict) -> Dict[str, bool]:
        ...
        overall_valid = (
            structure_result["has_required_fields"]
            and ranges_result["values_in_range"]
            and consistency_result["calories_consistent"]
        )
